# src/micro_harness/tui/app.py
"""Main TUI application for zero-agent."""
...
from micro_harness.builtin.shell import execute as shell_execute

from micro_harness.tui.widgets import Header, MessageList, InputBox, Footer
from micro_harness.tui.screens import PermissionScreen, TrustDialog


# Multi-language text
I18N = {
    "en": {
        "welcome": "Welcome to Zero Agent! Type your message or /help for commands.",
    ...
    "zh": {
        "welcome": "欢迎使用 Zero Agent！输入消息或 /help 查看命令。",
        "cleared": "历史已清空。",
        "mode_changed": "模式: {}",
        "lang_changed": "语言: {}",
    ...
    "ja": {
        "welcome": "Zero Agent へようこそ！メッセージを入力するか /help でコマンドを確認。",
        "cleared": "履歴をクリアしました。",
        "mode_changed": "モード: {}",
        "lang_changed": "言語: {}",
