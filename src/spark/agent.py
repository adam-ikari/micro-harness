...
from spark.prompts import get_system_prompt, build_context_aware_prompt, detect_context
from spark.feedback import HallucinationPreventer, ResultStatus
...
I18N = {
    "en": {
        "welcome": "Spark. Tab=mode, Ctrl+T=lang, /exit to quit, /help for commands.",
        "mode_switch": "Mode: {}",
        "cleared": "Cleared.",
...
Shortcut: Tab to cycle modes""",
    ...
    "zh": {
        "welcome": "Spark. Tab=模式, Ctrl+T=语言, /exit 退出, /help 帮助。",
        "mode_switch": "模式: {}",
        "cleared": "已清空。",
...
快捷键:
  ...
  Ctrl+T: 切换语言""",
    ...
    "ja": {
        "welcome": "Spark. Tab でモード切替, /exit で終了, /help でヘルプ。",
        "mode_switch": "モード: {}",
        "cleared": "クリアしました。",
...
class Agent:
    ...
    def start_repl(self) -> None:
        ...
        session = PromptSession(
            history=FileHistory(".spark_history"),
            key_bindings=kb,
        )
