...
class MessageList(ScrollableContainer):
    ...
    def add_user_message(self, content: str) -> str:
        """Add user message."""
        from zero_agent.tui.widgets.message_item import UserMessage
    ...
    def add_assistant_message(self, content: str = "") -> str:
        """添加助手消息。"""
        from zero_agent.tui.widgets.message_item import AssistantMessage
    ...
    def add_tool_message(self, tool_name: str, args: dict, status: str = "pending") -> str:
        """添加工具消息。"""
        from zero_agent.tui.widgets.message_item import ToolMessage
